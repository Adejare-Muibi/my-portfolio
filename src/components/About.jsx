      ...
      <div className='flex max-md:flex-col max-md:gap-6 justify-around items-center w-[100%] max-md:overflow-x-hidden' data-aos="fade-up">
        <div className='flex lg:gap-[170px] gap-[12px]'>
          <div className='flex gap-5 flex-col'>
            ...
            <div className='flex gap-3 border-b-[0.5px] pb-[7px] items-center border-[#363434]'>
              <h1 className=''><span className='font-semibold text-[20px] max-md:text-[16px]'>Phone :</span> <span className='ml-1 text-[13px] max-md:w-[6vw]'><Link target='_blank' className='text-[#96BB7C]' href={'https://wa.me/2348102780804'}>+2348102780804</Link></span></h1>
            </div>
            <div className='flex gap-3 border-b-[0.5px] pb-[7px] items-center border-[#363434]'>
          ...
          <div className='flex gap-5 flex-col'>
            <div className='flex gap-3 border-b-[0.5px] pb-[7px] items-center border-[#363434]'>
              <h1 className=''><span className='font-semibold text-[20px] max-md:text-[16px]'>Github :</span> <span className='ml-1 text-[13px]'><Link target='_blank' className='text-[#96BB7C]' href={'https://github.com/adejare-muibi'}>github.com</Link></span></h1>
            </div>
            <div className='flex gap-3 border-b-[0.5px] pb-[7px] items-center border-[#363434]'>
              <h1 className='max-md:w-[20vw]'><span className='font-semibold max-md:text-[16px]'>Linkdin :</span> <span className='ml-1 text-[13px]'><Link target='_blank' className='text-[#96BB7C]' href={'https://www.linkedin.com/in/adejare-muibi-4462191b0/'}>linkedin.com</Link></span></h1>
            </div>
            <div className='flex gap-3 border-b-[0.5px] pb-[7px] items-center border-[#363434]'>
            ...
            <div className='flex gap-3 border-b-[0.5px] pb-[7px] items-center border-[#363434]'>
              <h1 className=''><span className='font-semibold text-[20px] max-md:text-[16px]'>Twitter :</span> <span className='ml-1 text-[13px]'><Link target='_blank' className='text-[#96BB7C]' href={'https://x.com/tweetofjumuah'}>@TweetOfJumuah</Link></span></h1>
            </div>
          </div>
        </div>
